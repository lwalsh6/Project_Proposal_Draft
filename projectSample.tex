...
This project is intended for those who want some finer control over the playback of their video files.
...
I believe the two hardest things to make would likely be the video timeline and adding a full screen function
